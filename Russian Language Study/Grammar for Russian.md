...
|    |阳性|阴性|中性|复数|
|----|--------|--------|--------|--------|
|原型|один    |одна    |одно    |одни    |
|二格|одного  |одной   |одного  |одних   |
|三格|одному  |одной   |одному  |одним   |
|四格|        |одну    |одно    |        |
|五格|одним   |одной   |одним   |одними  |
|六格|одном   |одной   |одном   |одних   |

### 2 3 4 变格

|    |два     |три     |четыре  |
|----|--------|--------|--------|
|原型|два(две)|три     |четыре  |
|二格|двух    |трёх    |четырёх |
|三格|двум    |трём    |четырём |
|四格|        |        |        |
|五格|двумя́   |тремя́   |четырьмя́|
|六格|двух    |трёх    |четырёх |

### 5-20 30 变格

|    |пять    |восемь  |одиннадцать |
|----|--------|--------|------------|
|原型|пять    |восемь  |одиннадцать |
|二格|пяти    |восьми́  |одиннадцати |
|三格|пяти    |восьми́  |одиннадцати |
|四格|        |        |            |
|五格|пятью   |восьмью́ |одиннадцатью|
|六格|пяти    |восьми́  |одиннадцати |

### 40 90 100 变格

|    |сорок   |девяносто   |сто |
|----|--------|------------|----|
|原型|сорок   |девяносто   |сто |
|二格|сорока  |девяноста   |ста |
|三格|сорока  |девяноста   |ста |
|四格|        |            |    |
|五格|сорока  |девяноста   |ста |
|六格|сорока  |девяноста   |ста |

### третий 变格

|    |阳性|阴性|中性|复数|
|----|--------|--------|--------|--------|
|原型|третий  |третья  |третье  |третьи  |
|二格|третьего|третьей |третьего|третьих |
|三格|третьему|третьей |третьему|третьим |
|四格|        |третью  |третье  |        |
|五格|третьим |третьей |третьим |третьими|
|六格|третьем |третьей |третьем |третьих |
...
|    |двое    |трое    |четверо     |
|----|--------|--------|------------|
|原型|двое    |трое    |четверо     |
|二格|двоих   |троих   |четверых    |
|三格|двоим   |троим   |четверым    |
|四格|        |        |            |
|五格|двоими  |троими  |четверыми   |
|六格|двоих   |троих   |четверых    |
